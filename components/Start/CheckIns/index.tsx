          ...
          <>
            ...
            >
              ...
              {data && data.length < 4 && (
                ...
                >
                  Not enough data yet - complete {4 - data.length} more
                  check-ins daily to view your chart.
                </Box>
              )}
            </div>
            <Box sx={{ px: 3 }}>
              <Alert icon="🧠">
                Your mental health is private, and other members won&apos;t be
                able to view anything here
              </Alert>
            </Box>
            <Box sx={{ mt: 5 }} />
          </>
